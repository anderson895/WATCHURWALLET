...
public class admin implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("admin"), "b4a.example.admin");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, admin.class);
...
public static RemoteObject _btnupdate = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"account",Debug.moduleToString(b4a.example.account.class),"Activity",admin.mostCurrent._activity,"B4XTable1",admin.mostCurrent._b4xtable1,"btnDelete",admin.mostCurrent._btndelete,"btnUpdate",admin.mostCurrent._btnupdate,"dashboard",Debug.moduleToString(b4a.example.dashboard.class),"DateUtils",admin.mostCurrent._dateutils,"editexpenses",Debug.moduleToString(b4a.example.editexpenses.class),"editgoals",Debug.moduleToString(b4a.example.editgoals.class),"expenses",Debug.moduleToString(b4a.example.expenses.class),"goal",Debug.moduleToString(b4a.example.goal.class),"home",Debug.moduleToString(b4a.example.home.class),"inpdlg",admin.mostCurrent._inpdlg,"Main",Debug.moduleToString(b4a.example.main.class),"myacc",Debug.moduleToString(b4a.example.myacc.class),"rs",admin._rs,"signup",Debug.moduleToString(b4a.example.signup.class),"sql",admin._sql,"Starter",Debug.moduleToString(b4a.example.starter.class),"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}