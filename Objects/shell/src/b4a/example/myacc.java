...
public class myacc implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("myacc"), "b4a.example.myacc");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, myacc.class);
...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"account",Debug.moduleToString(b4a.example.account.class),"Activity",myacc.mostCurrent._activity,"admin",Debug.moduleToString(b4a.example.admin.class),"dashboard",Debug.moduleToString(b4a.example.dashboard.class),"DateUtils",myacc.mostCurrent._dateutils,"editexpenses",Debug.moduleToString(b4a.example.editexpenses.class),"editgoals",Debug.moduleToString(b4a.example.editgoals.class),"EditText1",myacc.mostCurrent._edittext1,"expenses",Debug.moduleToString(b4a.example.expenses.class),"goal",Debug.moduleToString(b4a.example.goal.class),"home",Debug.moduleToString(b4a.example.home.class),"ListView1",myacc.mostCurrent._listview1,"Main",Debug.moduleToString(b4a.example.main.class),"signup",Debug.moduleToString(b4a.example.signup.class),"sql",myacc._sql,"Starter",Debug.moduleToString(b4a.example.starter.class),"txtemail",myacc.mostCurrent._txtemail,"txtfname",myacc.mostCurrent._txtfname,"txtlname",myacc.mostCurrent._txtlname,"txtusername",myacc.mostCurrent._txtusername,"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}